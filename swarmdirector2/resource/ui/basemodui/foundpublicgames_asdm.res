"Resource/UI/FoundPublicGames_ASDM.res"
{
	"FoundPublicGames"
	{
		"ControlName"					"Frame"
...
// 	}
	...
	"DrpFilterEnergyWeapons" [$WIN32]
	{
		"ControlName"		"DropDownMenu"
		"fieldName"			"DrpFilterEnergyWeapons"
		"xpos"				"c-265"
		"ypos"				"365"
		"zpos"				"1"
		"wide"				"320"
		...
		"BtnDropButton"
		{
			...
			"enabled"		"1"
			"tabPosition"	"0"
			"labelText"		"#L4D360UI_FoundPublicGames_Filter_EnergyWeapons"
			"tooltiptext"	"#L4D360UI_FoundPublicGames_Filter_EnergyWeapons_Tip"
			"style"			"DropDownButton"
			"command"		"FlmFilterEnergyWeapons"
			"allcaps"			"1"
		}
	}

	"FlmFilterEnergyWeapons" [$WIN32]
	{
		"ControlName"		"FlyoutMenu"
		"fieldName"			"FlmFilterEnergyWeapons"
		"visible"			"0"
		"wide"				"0"
		"tall"				"0"
		"zpos"				"4"
		"InitialFocus"		"BtnAny"
		"ResourceFile"		"resource/UI/basemodui/DropDownFoundGamesFilterEnergyWeapons.res"
	}
