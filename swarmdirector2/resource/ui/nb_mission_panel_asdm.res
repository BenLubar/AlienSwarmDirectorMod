"Resource/UI/NB_Mission_Panel_ASDM.res"
{
	"MissionPanel"
	{
	...
	"DrpEnergyWeapons"
	{
		...
		"BtnDropButton"
		{
			...
			"enabled"						"1"
			"tabPosition"					"0"
			"labelText"						"#nb_energyweapons_title"
			"tooltiptext"					""
			"disabled_tooltiptext"			""
			"style"							"DropDownButton"
			"command"						"FlmEnergyWeapons"
			"ActivationType"				"1" [$X360]
			"EnableCondition"				"Never" [$DEMO]
		}
	}
	...
	{
		"ControlName"			"FlyoutMenu"
		"fieldName"				"FlmEnergyWeapons"
		"visible"				"0"
		"wide"					"0"
		"tall"					"0"
		"zpos"					"4"
		"InitialFocus"			"BtnCampaign1"
		"ResourceFile"			"resource/UI/basemodui/DropDownEnergyWeapons.res"
	}
