...
{		
	int iHealth = ASWGameRules()->ModifyAlienHealthBySkillLevel( 1000 ) + m_nExtraHeath; // was 500 - 2/19/10
...
{
	// make marines shoot at the bubble instead of the middle of the body
	int dummy, nHitbox;
